...
|-|-|-|-|
| [**LoadedDicePatch**](<https://github.com/Neovitalism/NeoMixins/releases/tag/LoadedDicePatch-1.0.1>) | Fixes loaded dice and massively cleans up (and slightly optimizes) general multiple hit moves. | `Required` | `Required` |
